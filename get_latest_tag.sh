...
LATEST=$(gcloud container images describe europe-west3-docker.pkg.dev/vreshch-com-320817/${PROJECT}/${IMAGE}:latest  --format="value(image_summary.fully_qualified_digest)" | tr -d '\n')
echo "{\"image\": \"${LATEST}\"}"
