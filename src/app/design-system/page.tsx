...
function LogoSection() {
  return (
    <Section
      id="logo"
      title="App Icon"
      subtitle="Signal V — navy rounded square, white V stroke, amber broadcast arc (32×32 native)."
    >
...
function ColorsSection() {
  const colors = [
    ...
    { name: 'Primary', light: '#1e3a5f', dark: '—', variable: '--color-primary' },
    {
      ...
      light: '#eef2f7',
      dark: '#2e3039',
      variable: '--color-surface / --color-dark-surface',
    },
    {
      name: 'Heading',
      light: '#1e3a5f',
      dark: '#ffffff',
      variable: '--color-heading / --color-dark-text',
    },
    {
      name: 'Body',
      light: '#374a60',
      dark: '#a9adc1',
      variable: '--color-body / --color-dark-text-secondary',
    },
    { name: 'Muted', light: '#5a6d82', dark: '#a9adc1', variable: '--color-muted' },
    {
      ...
      light: '#c2cdd9',
      dark: '#3a3d4a',
      variable: '--color-border / --color-dark-border',
    },
  ];
  ...
  return (
    <Section
      id="colors"
      title="Colors"
      subtitle="Semantic color tokens defined in globals.css via @theme"
    >
        ...
        {colors.map((c) => (
          <div key={c.name} className="rounded-2xl bg-surface p-4 dark:bg-dark-surface">
            <div className="mb-3 flex gap-2">
              ...
              {c.dark !== '—' && (
                <div
                  className="h-10 w-10 rounded-lg border border-border/30 dark:border-dark-border"
    ...
    <Section id="typography" title="Typography" subtitle="Headings, body text, labels, and links">
      <ShowcaseBox label="Headings & Text">
        <div className="space-y-6">
          <div>
            <h1 className="text-3xl font-medium text-heading dark:text-dark-text md:text-5xl md:leading-tight">
              Page Heading h1
            </h1>
          </div>
          <div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <ShowcaseBox label="On Surface">
          ...
          <Row>
            <button
              type="button"
              className="inline-block rounded-full bg-surface-alt px-8 py-3.5 text-sm font-medium text-heading transition-colors hover:bg-surface-hover dark:bg-dark-surface-alt dark:text-dark-text dark:hover:bg-dark-surface"
            >
              Secondary Action
            </button>
          </Row>
          <Row>
            <button
              type="button"
              className="inline-flex items-center gap-2 text-sm font-medium text-accent transition-colors hover:text-accent-hover dark:text-dark-accent dark:hover:text-dark-accent-hover"
            >
              Text Link
              <ArrowIcon />
            </button>
        ...
        <DarkBox label="On Dark Background">
          <Row>
            <button
              type="button"
              className="inline-block rounded-full bg-white px-8 py-3.5 text-sm font-medium text-primary shadow-md transition-all hover:bg-white/90 hover:shadow-lg"
            >
              Primary on Dark
            </button>
          </Row>
          <Row>
            <button
              type="button"
              className="inline-block rounded-full border-2 border-white px-8 py-3.5 text-sm font-medium text-white transition-all hover:bg-white hover:text-primary"
            >
              Secondary on Dark
            </button>
          </Row>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <ShowcaseBox label="On Surface">
          <Row>
            ...
            <span className="inline-block rounded-full bg-accent px-3 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-white">
              New
            </span>
          </Row>
          <Row>
            <span className="inline-block rounded-md bg-accent/12 px-2.5 py-0.5 text-xs font-semibold text-accent dark:bg-dark-accent/10 dark:text-dark-accent">
              v6.0
            </span>
            <span className="inline-block rounded-md bg-surface-alt px-2.5 py-0.5 text-xs font-semibold text-muted dark:bg-dark-surface-alt dark:text-dark-text-secondary">
              v5.0
            </span>
            <span className="inline-block rounded-md bg-surface-alt px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-muted dark:bg-dark-surface-alt dark:text-dark-text-secondary">
              React
            </span>
            <span className="inline-block rounded-md bg-surface-alt px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-muted dark:bg-dark-surface-alt dark:text-dark-text-secondary">
              Next.js
...
function CardsSection() {
  return (
    <Section
      id="cards"
      title="Cards"
      subtitle="Borderless cards with surface background and hover variants"
    >
      <div className="grid gap-6 md:grid-cols-3">
        <Card hover="lift">
          ...
          <p className="text-sm leading-relaxed text-muted dark:text-dark-text-secondary">
            Hover to see the lift effect with shadow transition.
          </p>
        </Card>
        <Card hover="border">
          <div className="mb-4 inline-flex h-10 w-10 items-center justify-center rounded-lg bg-accent/10 text-accent dark:bg-dark-accent/10 dark:text-dark-accent">
          ...
          <p className="text-sm leading-relaxed text-muted dark:text-dark-text-secondary">
            Hover to see the accent border highlight.
          </p>
        </Card>
        <Card>
          <h3 className="mb-2 text-base font-medium text-heading dark:text-dark-text">
          ...
          <ul className="mt-3 space-y-2 text-sm text-body dark:text-dark-text">
            <li className="flex items-center gap-2">
              <span className="text-accent dark:text-dark-accent">&#8226;</span>Bullet item one
            </li>
            <li className="flex items-center gap-2">
              <span className="text-accent dark:text-dark-accent">&#8226;</span>Bullet item two
            </li>
            <li className="flex items-center gap-2">
              <span className="text-accent dark:text-dark-accent">&#8226;</span>Bullet item three
            </li>
          </ul>
        </Card>
      </div>
...
function IconsSection() {
  return (
    <Section
      ...
      subtitle="Accent-tinted background containers at three sizes"
    >
      <ShowcaseBox label="Sizes">
        <Row>
          <div className="flex items-center gap-6">
            <div className="text-center">
              <div className="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-accent/10 text-accent dark:bg-dark-accent/10 dark:text-dark-accent">
                <CheckIcon />
              </div>
              <p className="mt-2 text-xs text-muted dark:text-dark-text-secondary">32px</p>
            </div>
            <div className="text-center">
              <div className="inline-flex h-10 w-10 items-center justify-center rounded-lg bg-accent/10 text-accent dark:bg-dark-accent/10 dark:text-dark-accent">
                <CheckIcon />
              </div>
              <p className="mt-2 text-xs text-muted dark:text-dark-text-secondary">40px</p>
            </div>
            <div className="text-center">
              <div className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-accent/10 text-accent dark:bg-dark-accent/10 dark:text-dark-accent">
                <CheckIcon />
              </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <ShowcaseBox label="On Surface">
          <Row>
            <a
              href="#"
              className="inline-flex items-center gap-1.5 text-sm font-medium text-accent transition-colors hover:text-accent-hover dark:text-dark-accent dark:hover:text-dark-accent-hover"
            >
              <ExternalLinkIcon />
...
function NavigationSection() {
  return (
    <Section
      id="navigation"
      title="Navigation"
      subtitle="Sticky top nav with active indicator and mobile hamburger"
    >
...
function SpacingSection() {
  return (
    <Section
      ...
      subtitle="Container widths, gaps, and padding patterns"
    >
      <ShowcaseBox label="Patterns">
        <div className="space-y-4 text-sm text-muted dark:text-dark-text-secondary">
          <div className="flex items-baseline gap-4">
            <span className="w-32 flex-shrink-0 text-xs font-medium uppercase tracking-widest">
              Container
            </span>
            <code className="rounded bg-surface-alt px-2 py-0.5 text-xs dark:bg-dark-surface-alt">
